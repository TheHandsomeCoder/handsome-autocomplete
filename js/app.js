...
app.factory('MovieRetriever', function($http, $q, $timeout){
  ...
  MovieRetriever.getmovies = function(i) {
    ...
    var moreMovies = [{name: "Scott O'Malley Wolverine", club:"Salle Dublin" }, {name: "Smurffete", club:"Salle Room" },{name:  "Pembroke Fencer 1" , club:"Pembroke" }, {name: "Laura Jameson", club:"Salle Rocks" }];
